...
#There is a pretty strong correltion between Weight(g) and Tumor V as the correlation is close to one.

#Capomulin decreases tumor volume for a certain period of time before it loses its efficacy.

#The drug seems to lose efficacy with the higher the weight of the mouse.
